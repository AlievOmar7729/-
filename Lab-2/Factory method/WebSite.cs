namespace Factory_method
{
    public class WebSite : PurchaseMethod
    {
        ...
        {
            Console.WriteLine($"Payment for a subscription through the WebSite system for the following subscription:");
            ...
            {
                Console.WriteLine("Payment confirmed! Subscription successfully purchased through the website.\n");
